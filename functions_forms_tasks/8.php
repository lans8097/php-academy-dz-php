...
if(!empty($_POST)){
    ...
    $text = (!empty($_POST['message']))?strip_tags(trim($_POST['message']),'<br>'):false;
    $errors = [];
    ...
    //Проверка на мат
    elseif(preg_match('#('.implode('|',['говнокод','урод']).')#ui',$text)){
        $errors[] = 'Вы использовали запретное слово';
    }
...
<div class="main">
    <div class="title">
        <h3>Задание №8</h3>
        <p>
            Создать гостевую книгу, где любой человек может оставить комментарий в текстовом поле и добавить его. Все добавленные комментарии выводятся над текстовым полем. Реализовать проверку на наличие в тексте запрещенных слов, матов. При наличии таких слов - выводить сообщение "Некорректный комментарий". Реализовать удаление из комментария всех тегов, кроме тега &lt;br&gt; .
        </p>
    </div>
    <div class="content">
        ...
        <div class="addForm">
            <form action="8.php" method="post">
                ...
                <p>Слова 'говнокод','урод' запрещены!!!</p>
